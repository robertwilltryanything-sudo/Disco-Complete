...
import { WantlistItem, MediaType } from '../types';
...
interface AddWantlistItemFormProps {
  ...
  onCancel: () => void;
  // FIX: Added mediaType prop to be passed to the item
  mediaType: MediaType;
}

// FIX: Added mediaType to props destructuring
const AddWantlistItemForm: React.FC<AddWantlistItemFormProps> = ({ onSave, itemToEdit, onCancel, mediaType }) => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
        // FIX: Added mediaType to itemData to satisfy WantlistItem type
    ...
    // FIX: Added mediaType to dependency array
